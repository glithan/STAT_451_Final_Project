...
```{r data}
gdp_data = read.csv("C:\\Users\\pvaso\\Downloads\\GDP.PCAP (1).csv", skip = 3)
gdp_data2 = read.csv("C:\\Users\\pvaso\\Downloads\\GDP.PCAP (1).csv", skip = 3)
demog_data = read.csv("C:\\Users\\pvaso\\Downloads\\UNdata_secondary_enrollment.csv")
demog_data2 = read.csv("C:\\Users\\pvaso\\Downloads\\UNdata_secondary_enrollment.csv")
gdpmeta_data = read.csv("C:\\Users\\pvaso\\Downloads\\Metadata_Country_API_NY.GDP.PCAP.CD_DS2_en_csv_v2_9803.csv")
gdpmeta_data2 = read.csv("C:\\Users\\pvaso\\Downloads\\Metadata_Country_API_NY.GDP.PCAP.CD_DS2_en_csv_v2_9803.csv")
```
