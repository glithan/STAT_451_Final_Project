...
```{r data}
gdp_data = read.csv("API_NY.GDP.PCAP.CD_DS2_en_csv_v2_9803.csv", skip = 3)
demog_data = read.csv("UNdata_Export_20241109_205550357.csv")
gdpmeta_data = read.csv("Metadata_Country_API_NY.GDP.PCAP.CD_DS2_en_csv_v2_9803.csv")
```
